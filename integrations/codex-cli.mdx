...
**2. Install the plugin** by following the [Codex plugin installation docs](https://developers.openai.com/codex/plugins). You'll point Codex at the cloned plugin directory to register it as a personal plugin.
