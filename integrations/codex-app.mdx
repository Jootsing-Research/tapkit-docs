...
**3. Install the plugin** — restart Codex, then go to **Plugins** in the left sidebar. In the plugins page, change the dropdown from **Built by OpenAI** to **TapKit**, then install the plugin.
